...
- ‘계약·권위·효과·경계’ 같은 단어는 금지 목록이 아니라 검토 신호로 사용합니다. 실제 코드·스키마·도메인 식별자는 보존하고, 일반 산문에서 기능이 분명하며 고정 명칭이 아닌 어색한 표현만 고칩니다. 표제·링크 라벨·용어집·반복 도메인명은 일부만 자동 개명하지 않고 전역 일관성 검토를 제안합니다.
...
| 18 | 번역투·장황한 보조 표현과 문맥에 맞지 않는 직역 | “~에 있어서 역할을 수행·권위 구현·설치 계약·허용 효과” | 검토 신호로 판정해 일반 산문의 어색한 표현만 고치고, 식별자·전문 용어·고정 명칭은 보호한다 |
